// Base de datos de noticias
        const noticias = [
            ...
            //},
            {
                ...
                textoCompleto: "<strong>CECATI celebra 63 años de transformar a México a través de la capacitación para el trabajo</strong> En el marco de la celebración por el <strong>63 aniversario de los Centros de Capacitación para el Trabajo Industrial (CECATI)</strong>, se llevó a cabo la inauguración de la <strong>Primera Muestra Museográfica de Creaciones Educativas de los CECATI</strong>, encabezada por autoridades de la Secretaría de Educación Pública. Acompañado por la subsecretaria de Educación Media Superior, <strong>Mtra. Tania Rodríguez Mora</strong>, se realizó el corte del listón inaugural de esta exposición, que reúne una muestra representativa del talento, la creatividad y las competencias que las y los estudiantes desarrollan diariamente en las aulas y talleres de los CECATI. La muestra integra proyectos de diversas áreas de formación, entre ellos propuestas de <strong>tecnología sustentable, mecánica automotriz y expresiones artísticas</strong>, demostrando cómo la capacitación para el trabajo se traduce en conocimientos, innovación y soluciones con impacto en la sociedad. Durante el recorrido se reconoció especialmente a las y los estudiantes que destacaron en esta muestra por la creatividad, dedicación y calidad de sus proyectos, convirtiéndose en ejemplo e inspiración para toda la comunidad educativa. Asimismo, se destacó la labor de <strong>docentes, directivos y personal de los planteles</strong>, cuyo compromiso y trabajo en equipo hacen posible que los CECATI continúen fortaleciendo las habilidades y competencias de las nuevas generaciones. Con 63 años de trayectoria, los CECATI refrendan su compromiso de <strong>formar para el trabajo, impulsar el talento y generar oportunidades</strong>, contribuyendo al desarrollo económico y social de México. Esta celebración representa no solo una mirada al camino recorrido, sino también un impulso para continuar construyendo, desde la educación y la capacitación, el futuro laboral de nuestro país.",
