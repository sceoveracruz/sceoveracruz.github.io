// Base de datos de noticias
        const noticias = [
            ...
            //},
            {
                ...
                textoCompleto: "Poza Rica, Veracruz.<br><br>El Centro de Capacitación para el Trabajo Industrial (CECATI) No. 103 llevó a cabo la ceremonia de clausura de cursos correspondiente al ciclo escolar 2025–2026, encabezada por la directora del plantel, Dra. María Silvia Mujica Ramírez, con la distinguida presencia de autoridades educativas, gubernamentales, representantes del sector empresarial, así como de docentes, personal administrativo, estudiantes y familiares.<br><br>Durante la ceremonia se reconoció el esfuerzo, la dedicación y el compromiso de las y los alumnos que concluyeron exitosamente su formación, destacando la importancia de la capacitación para el trabajo como una herramienta que impulsa el desarrollo profesional y fortalece el crecimiento de la comunidad.<br><br>En el evento también se entregaron reconocimientos al Pentathlón Deportivo Militarizado Universitario de Poza Rica por su valioso apoyo institucional; a los alumnos Jesús Alberto Salazar Méndez y Gerardo González Moncada, por su destacada participación en el Primer Concurso Nacional de Creaciones Educativas; y a las personas e instituciones que colaboraron en la operación de la cocina comunitaria instalada en el plantel para apoyar a las familias afectadas por las inundaciones del pasado 10 de octubre.<br><br>Asimismo, la Mtra. Karla Oyuki Rubio Garrido, rectora de la Universidad de Oriente, reconoció el compromiso del personal directivo, docente y administrativo del CECATI 103 por su labor en la formación de profesionales con habilidades y valores al servicio de la sociedad.<br><br>Al finalizar la ceremonia, el CECATI 103 felicitó a las y los egresados por este importante logro y los exhortó a continuar preparándose para enfrentar los retos del ámbito laboral y contribuir al desarrollo de sus comunidades, reafirmando su compromiso con una educación de calidad, incluyente y con sentido social.",
